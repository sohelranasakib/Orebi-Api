...
const BagP = () => {
    ...
    let bag = data.filter(product => product.id >= 172 && product.id <= 176);
    
  return (
    <section className=' pt-[220px] pb-[50px] lg:px-0 px-2'>
        <Container>
        <div className=" items-center pb-[40px]">
                    <h2 className='font-sans font-bold   text-[32px]  text-[#262626] '>Bags Products</h2>
                    <h3 className='font-sans font-bold   text-[16px]  text-[#262626] '><Link to="/">Home </Link> +  Bags Products</h3>
                </div>
        </Container>
       <div className="">
                <Tabs>
