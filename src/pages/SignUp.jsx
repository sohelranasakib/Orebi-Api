                ...
                <form action="">
                    ...
                    <div className=" lg:flex lg:justify-between relative after:absolute after:contain-[''] after:h-[2px] after:w-[100%] after:bottom-[-80px] after:left-0 after:bg-[#BCC6CC] ">
                        ...
                        <div className="lg:w-[48%] w-full lg:px-0 px-3">
                            ...
                            <input className='w-full h-[50px] border-b-2 outline-none' type="text" placeholder='Your Email address...' />
                        </div>
                        <div className="lg:w-[48%] w-full lg:px-0 px-3">
                    ...
                    <div className=" lg:flex lg:justify-between  ">
                        ...
                        <div className="lg:w-[48%] w-full lg:px-0 px-3 relative ">
                            ...
                            <input className='w-full h-[50px] border-b-2 outline-none' type={pshow ? "text" : "password"} placeholder='Password' />
                        ...
                        <div className="lg:w-[48%] w-full lg:px-0 px-3 relative ">
                            ...
                            <input className='w-full h-[50px] border-b-2 outline-none' type={pshowe ? "text" : "password"} placeholder='Password' />
                    ...
                    <div  className="h-[50px] w-[180px] bg-[#000] my-[100px] items-center mx-[50%] translate-x-[-50%] lg:mx-0 lg:translate-x-0 cursor-pointer">
