...
const Navber = () => {
    ...
    return (
        <section className=' w-full pt-[80px] fixed z-50'>
            ...
            <Container>
                <Flex className=" h-[100px] items-center">
                    <div className=" lg:w-[30%] w-full">
                        ...
                        {cartShow &&
                            <div className=" absolute z-50 top-[150px] left-[120px] bg-[#262626] w-[300px] rounded-lg">
                                <ul>
                    ...
                    <div className=" w-[30%] flex gap-2 justify-end">
                        <div ref={accountref} className=" relative flex">
                    ...
                    {accountShow &&
                        <div className="absolute z-50 top-[150px] right-[150px] w-[200px] py-[10px] bg-[#262626]">
                     ...
                     {userShow &&
                    <div className=" absolute w-[300px] top-[150px] right-[100px]  bg-black  py-3 ">
